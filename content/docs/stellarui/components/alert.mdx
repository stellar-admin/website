...
<Callout type="info">
  All of the individual alert-related Tag Helpers render a `<div>` element. As such, you
  can add any of the [`div`
  attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/div)
