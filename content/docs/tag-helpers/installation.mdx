...
<Steps>
    ...
    <Step>
        ...
        StellarAdmin Tag Helpers includes eight shadcn-derived themes—Vega, Nova, Maia, Lyra, Mira, Luma, Sera, and Rhea—and the independently designed Ledger theme. You must add the stylesheet for the theme you want to use to your Razor layout. The URL for the theme is in the format (`/_content/StellarAdmin.TagHelpers/stellar-admin.<theme>.css`).
