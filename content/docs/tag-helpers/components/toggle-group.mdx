...
<sa-toggle-group label="Travel style" class-names="@partClasses">
    <sa-toggle-group-item value="guided">Guided tour</sa-toggle-group-item>
    <sa-toggle-group-item value="independent">Independent travel</sa-toggle-group-item>
</sa-toggle-group>
```
