...
<sa-input-group>
  ...
  <sa-input-group-addon align="InputGroupAddOnVariantAlignment.InlineEnd">
    <sa-input-group-button class="rounded-full" size="InputGroupButtonSize.IconExtraSmall" aria-label="More information">
      <sa-icon name="info"/>
...
<sa-input-group>
  ...
  <sa-input-group-addon align="InputGroupAddOnVariantAlignment.BlockEnd">
    ...
    <sa-separator orientation="SeparatorOrientation.Vertical" class="!h-4"/>
    <sa-input-group-button
