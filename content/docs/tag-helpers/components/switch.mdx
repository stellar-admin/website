...
@{
    ...
    {
        Thumb = "travel-switch-thumb"
    };
}

<sa-switch label="Trip reminders" class-names="@partClasses" />
```
...
| `Input` | The native checkbox input with role="switch". |
| `Thumb` | The moving thumb inside the switch. |
