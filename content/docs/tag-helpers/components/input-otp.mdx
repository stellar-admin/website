...
<Demo src="/demo/tag-helpers/input-otp-class-names.html">
  <Tabs items={["Razor", "CSS"]}>
    <Tab value="Razor">
      <include>./_include/input-otp-class-names.mdx</include>
    </Tab>
    <Tab value="CSS">
      ```css
      .travel-field {
      ...
      .travel-input-otp-control {
          gap: 0.75rem;
      }

      .travel-input-otp-group {
          gap: 0.25rem;
      }

      .travel-input-otp-slot {
          border: 2px solid var(--travel-accent);
          border-radius: 0.5rem;
          color: var(--travel-accent);
      }

      .travel-input-otp-separator {
          color: var(--travel-accent);
