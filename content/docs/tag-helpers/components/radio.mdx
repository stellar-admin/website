...
@{
    ...
    {
        Indicator = "travel-radio-indicator"
    };
}

<sa-input type="radio" name="travelStyle" value="guided" label="Guided tour"
...
| `Indicator` | The visual radio indicator. |
| `Icon` | The SVG dot inside the indicator. |
