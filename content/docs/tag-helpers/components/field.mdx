...
<Demo src="/demo/tag-helpers/field-class-names.html">
  <Tabs items={["Razor", "CSS"]}>
    <Tab value="Razor">
      <include>./_include/field-class-names.mdx</include>
    </Tab>
    <Tab value="CSS">
      ```css
      .account-field {
          ...
          background: color-mix(in srgb, var(--account-accent) 8%, transparent);
      }

      .dark .account-field {
          --account-accent: #5eead4;
      }
...
All properties below are optional strings containing space-separated CSS classes. Classes are added to the component's existing classes.
...
Input-specific properties target the control itself. For example, `InputClassNames.Input` styles the native `<input>` in this example.
...
Renders a `<p>` element with help text for a field, forwarding any [global attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes).
...
Renders a `<div>` element with `role="alert"` that displays a validation message, forwarding any [global attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes). It is hidden unless a validation error is present.
...
Renders a `<div>` element for a non-`<label>` field title, forwarding any [global attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes).

### `<sa-field-content>`

Renders a `<div>` element that groups the label and description of a horizontal field, forwarding any [global attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes).

### `<sa-field-group>`

Renders a `<div>` element that stacks related fields, forwarding any [global attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes).
