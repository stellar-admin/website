...
The following themes were designed specifically for StellarAdmin. All of the themes were designed with specific font sets in mind which complements the look-and-feel of the theme. The font names and weights used are also listed in the table.


| Theme  | Stylesheet | Fonts |
| ------ | ---------- | --- |
...
Below are complete installation code snippets for each of the themes. Copy and paste it into your application.
...
<Callout type="idea">
You can self-host the fonts. For more information, refer to the Google Fonts documentation on [self-hosting web fonts](https://fonts.google.com/knowledge/using_type/self_hosting_web_fonts).
</Callout>
