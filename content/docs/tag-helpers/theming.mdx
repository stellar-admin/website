...
StellarAdmin ships twelve themes: Concourse, Ice, Ledger, Luma, Lyra, Maia, Mira, Nova, Observatory, Rhea, Sera, and Vega. Use the picker above any component example to compare them. The eight shadcn-derived themes share a base palette and differ in shape, spacing, and component styling. Concourse, Ice, Ledger, and Observatory are independently designed themes with their own palettes, typography, and control treatments.
