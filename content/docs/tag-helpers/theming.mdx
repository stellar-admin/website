...
StellarAdmin ships eleven themes: Concourse, Ice, Ledger, Luma, Lyra, Maia, Mira, Nova, Rhea, Sera, and Vega. Use the picker above any component example to compare them. The eight shadcn-derived themes share a base palette and differ in shape, spacing, and component styling. Concourse, Ice, and Ledger are independently designed themes with their own palettes, typography, and control treatments.
